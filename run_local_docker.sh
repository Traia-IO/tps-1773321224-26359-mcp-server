...
# Script to build and run the TPS_1773321224_26359 MCP Server locally in Docker
...
IMAGE_NAME="tps-1773321224-26359-mcp-server"
CONTAINER_NAME="tps-1773321224-26359-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running TPS_1773321224_26359 MCP Server...${NC}"
echo
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        cat > .env << EOF
# TPS_1773321224_26359 MCP Server Configuration
PORT=8000
STAGE=MAINNET
LOG_LEVEL=INFO
...
echo
echo -e "${GREEN}✅ TPS_1773321224_26359 MCP Server is running!${NC}"
echo
